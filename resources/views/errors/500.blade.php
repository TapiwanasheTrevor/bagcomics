...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .code { font-size: 5rem; font-weight: 800; color: #DC2626; line-height: 1; margin-bottom: 1rem; }
        h1 { font-size: 1.5rem; margin-bottom: 0.75rem; }
        p { color: #9ca3af; margin-bottom: 2rem; line-height: 1.6; }
        a { display: inline-block; background: #DC2626; color: #fff; padding: 0.75rem 2rem; border-radius: 0.75rem; text-decoration: none; font-weight: 600; transition: background 0.2s; }
